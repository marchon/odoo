...
class account_journal(models.Model):
    ...
    def _get_open_bills_to_pay_query(self):
        ...
        it as its second.
        """
        return ("""SELECT state, residual_signed as amount_total, currency_id AS currency, date_invoice, company_id
                  FROM account_invoice
                  WHERE journal_id = %(journal_id)s AND state = 'open';""", {'journal_id':self.id})
    ...
    def _get_draft_bills_query(self):
        ...
        """
        return ("""SELECT state, amount_total, currency_id AS currency, date_invoice, company_id
                  FROM account_invoice
