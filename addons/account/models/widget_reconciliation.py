...
class AccountReconciliation(models.AbstractModel):
    ...
    def get_move_lines_for_bank_statement_line(self, st_line_id, partner_id=None, excluded_ids=None, str=False, offset=0, limit=None):
        ...
        aml_recs = self._get_move_lines(aml_accounts, partner_id, excluded_ids=excluded_ids, str=str, offset=offset, limit=limit)
    ...
    def get_bank_statement_data(self, bank_statement_ids):
        ...
        if bank_statement_ids:
            ...
            params += (tuple(bank_statement_ids.ids),)
        ...
        return {
            ...
            'notifications': [],
            'statement_name': len(bank_statement_ids) == 1 and bank_statement_ids[0].name or False,
            'journal_id': bank_statement_ids and bank_statement_ids[0].journal_id.id or False,
    ...
    def get_all_data_for_manual_reconciliation(self, partner_ids, account_ids):
        ...
        """
        return {
            'customers': self._get_data_for_manual_reconciliation('partner', partner_ids, 'receivable'),
            'suppliers': self._get_data_for_manual_reconciliation('partner', partner_ids, 'payable'),
            'accounts': self._get_data_for_manual_reconciliation('account', account_ids),
        }
    ...
    def get_data_for_manual_reconciliation(self, res_type, res_ids=None, account_type=None):
        ...
        for row in rows:
            ...
            row['reconciliation_proposition'] = self._get_move_line_reconciliation_proposition(account.id, partner_id)
        return rows
    ...
    def _get_move_lines(self, aml_accounts, partner_id, excluded_ids=None, str=False, offset=0, limit=None):
        ...
        return Account_move_line.search(domain, offset=offset, limit=limit, order="date_maturity desc, id desc")
    ...
    def _get_move_line_reconciliation_proposition(self, account_id, partner_id=False):
        ...
        if len(rec_prop) > 0:
            ...
            return self._prepare_move_lines(rec_prop, target_currency=target_currency)
        return []
