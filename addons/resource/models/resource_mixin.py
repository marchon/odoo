...
class ResourceMixin(models.AbstractModel):
    ...
    def get_work_days_count(self, from_datetime, to_datetime, calendar=None, domain=[]):
    ...
    def get_work_hours_count(self, from_datetime, to_datetime, calendar=None, domain=[]):
    ...
    def get_work_days_data(self, from_datetime, to_datetime, calendar=None, domain=[]):
        days_count = 0.0
    ...
    def iter_works(self, from_datetime, to_datetime, calendar=None, domain=[]):
        calendar = calendar or self.resource_calendar_id
        return calendar._iter_work_intervals(from_datetime, to_datetime, self.resource_id.id, domain=domain)

    def iter_work_hours_count(self, from_datetime, to_datetime, calendar=None, domain=[]):
        calendar = calendar or self.resource_calendar_id
        return calendar._iter_work_hours_count(from_datetime, to_datetime, self.resource_id.id, domain=domain)

    def get_leaves_days_count(self, from_datetime, to_datetime, calendar=None, domain=[]):
    ...
    def get_leaves_hours_count(self, from_datetime, to_datetime, calendar=None, domain=[]):
    ...
    def get_leaves_days_data(self, from_datetime, to_datetime, calendar=None, domain=[]):
        days_count = 0.0
    ...
    def iter_leaves(self, from_datetime, to_datetime, calendar=None, domain=[]):
        calendar = calendar or self.resource_calendar_id
        return calendar._iter_leave_intervals(from_datetime, to_datetime, self.resource_id.id, domain=domain)

    def get_start_work_hour(self, day_dt, calendar=None, domain=[]):
        calendar = calendar or self.resource_calendar_id
    ...
    def get_end_work_hour(self, day_dt, calendar=None, domain=[]):
        calendar = calendar or self.resource_calendar_id
        work_intervals = calendar._get_day_work_intervals(day_dt, resource_id=self.resource_id.id, domain=domain)
