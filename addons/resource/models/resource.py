...
class ResourceCalendar(models.Model):
    ...
    @api.multi
    def _get_leave_intervals(self, resource_id=None, start_datetime=None, end_datetime=None, domain=[]):
        ...
        if end_datetime:
            ...
            search_domain += [('date_from', '<', fields.Datetime.to_string(start_datetime + timedelta(days=1)))]
    ...
    @api.multi
    def _get_day_work_intervals(self, day_date, start_time=None, end_time=None, compute_leaves=False, resource_id=None, domain=[]):
    ...
    def _get_day_leave_intervals(self, day_date, start_time, end_time, resource_id, domain=[]):
    ...
    def _iter_work_intervals(self, start_dt, end_dt, resource_id, compute_leaves=True, domain=[]):
    ...
    def _iter_leave_intervals(self, start_dt, end_dt, resource_id, domain=[]):
    ...
    def _iter_work_hours_count(self, from_datetime, to_datetime, resource_id, domain=[]):
    ...
    def _iter_work_days(self, from_date, to_date, resource_id, domain=[]):
    ...
    @api.multi
    def get_work_hours_count(self, start_dt, end_dt, resource_id, compute_leaves=True, domain=[]):
    ...
    @api.multi
    def _schedule_hours(self, hours, day_dt, compute_leaves=False, resource_id=None, domain=[]):
    ...
    @api.multi
    def _schedule_days(self, days, day_dt, compute_leaves=False, resource_id=None, domain=[]):
