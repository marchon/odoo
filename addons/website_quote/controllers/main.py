...
class sale_quote(http.Controller):
    ...
    def view(self, order_id, pdf=None, token=None, message=False, **post):
        ...
        values = {
            ...
            'tx_pending': transaction.pending if transaction else False,
            'tx_capture': transaction.capture if transaction else False,
            'tx_post_msg': transaction.acquirer_id.post_msg if transaction else False,
            'need_payment': order_sudo.invoice_status == 'to invoice' and transaction.state in ['draft', 'cancelled'],
            'token': token,
    ...
    def payment_transaction_token(self, acquirer_id, order_id, save_token=False,access_token=None, **kwargs):
        ...
        transaction = order.create_payment_transaction(vals)
    ...
    def payment_token(self, order_id, pm_id=None, **kwargs):
        ...
        order.create_payment_transaction(vals)
