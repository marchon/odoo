...
class RepoortIntrastatTest(common.TransactionCase):
    ...
    def _load(self, module, *args):
        tools.convert_file(self.cr, 'account_intrastat',
    ...
    def setUp(self):
        ...
        self.invoice = self.env['account.invoice'].create({
            ...
            'state': 'draft',
            'type': 'out_invoice',
            'account_id': self.ref('account_intrastat.a_recv'),
            'name': 'Test invoice 1'
        })

    def test_00_create_pdf(self):
        data, data_format = self.env.ref('account_intrastat.account_intrastatinvoices').render(self.invoice.ids)
