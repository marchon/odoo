...
class SaleOrderLine(models.Model):
    ...
    project_id = fields.Many2one('project.project', 'Generated Project', help="Project generated by the sales order item")
    task_id = fields.Many2one('project.task', 'Generated Task', help="Task generated by the sales order item")
