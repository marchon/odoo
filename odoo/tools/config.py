...
# should be the same as in selenite.py but cannot be imported so early
...
class configmanager(object):
    ...
    def _parse_config(self, args=None):
        ...
        keys = [
            ...
            'selenium_driver', 'selenium_driver_path', 'selenium_browser_path',
            'screenshot_path', 'headless',
